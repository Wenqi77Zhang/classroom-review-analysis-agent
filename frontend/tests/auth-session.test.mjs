...
assert.match(loginPage, /免注册进入共享演示工作区/);
assert.match(loginPage, /注册并进入工作区/);
assert.match(loginPage, /共享演示工作区/);
...
assert.match(registerRoute, /requestCameFromSameOrigin/);
assert.match(registerRoute, /account-registration/);
assert.match(registerRoute, /setAuthCookie/);
